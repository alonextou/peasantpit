...
function preload() {
    ...
    //game.load.spritesheet('ship', 'assets/images/player.png', 32, 32);
...
function create() {
    ...
    starfield = game.add.tileSprite(0, 0, game.width, game.height, 'stars');
    ...
    for (var i = 0; i < 4; i++)
    {
        ...
        panda.body.setRectangle(100, 100);
...
function hitPanda(body1, body2) {
    ...
    body2.angularVelocity = body1.angularVelocity;
